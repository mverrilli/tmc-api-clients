...
class ExecutionsApi(object):
    ...
    def execute(self, body, **kwargs):  # noqa: E501
        ...
        :param ExecutableTask body: Executable identifier (required)
    ...
    def get_execution_status_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='JobExecutionStatus',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def stop_execution(self, id, **kwargs):  # noqa: E501
        """Terminate Task execution  # noqa: E501

        Terminate Task execution  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stop_execution(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.stop_execution_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.stop_execution_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def stop_execution_with_http_info(self, id, **kwargs):  # noqa: E501
        """Terminate Task execution  # noqa: E501

        Terminate Task execution  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stop_execution_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `stop_execution`")  # noqa: E501
